...
export default function RestaurantWizard({
  ...
  const [priceRange, setPriceRange] = useState(1000); // integer
  ...
  const handleCreateRestaurant = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("price_range", String(priceRange)); // backend expects 'price_range'
      formData.append("location", location);
      formData.append("address", address);
      formData.append("chef", chef);
      formData.append("tags", tags);
      formData.append("available_slots", JSON.stringify(availableSlots)); // send as JSON string
