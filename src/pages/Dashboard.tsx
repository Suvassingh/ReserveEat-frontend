...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      ...
      try {
        ...
        toast.error(
          error.response?.data?.error || "Could not load your bookings",
        );
      } finally {
  ...
  // Fetch recommendations (trending restaurants)
  useEffect(() => {
    const fetchRecommendations = async () => {
      ...
      try {
        ...
        toast.error(
          error.response?.data?.error || "Could not load recommendations",
        );
      } finally {
